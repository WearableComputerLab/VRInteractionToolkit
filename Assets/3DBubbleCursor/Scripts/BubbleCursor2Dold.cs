...
public class BubbleCursor2Dold : MonoBehaviour {
    ...
    private float[][] ClosestObject() {
        ...
        for (int i = 0; i < circleObjects.Length; i++) {
            ...
            //dist += circleObjects[i].GetComponent<CircleCollider2D>().radius;
            if (i == 0) {
                lowestDist = dist;
                lowestValue = 0;
            } else {
    ...
    void Update() {
        ...
        lowestDistances[0][0] += circleObjects[(int)lowestDistances[0][1]].GetComponent<CircleCollider2D>().radius * circleObjects[(int)lowestDistances[0][1]].transform.localScale.x;
        lowestDistances[1][0] += circleObjects[(int)lowestDistances[1][1]].GetComponent<CircleCollider2D>().radius * circleObjects[(int)lowestDistances[1][1]].transform.localScale.x;
        ...
        //circleObjects[(int)lowestDistances[1][1]].transform.localScale.x
        ...
        //print("Second closest is object:" + circleObjects[(int)lowestDistances[1][1]].name);
        //print("before:" + SecondClosestCircleRadiusOld);
        //print("after:" + SecondClosestCircleRadius);
